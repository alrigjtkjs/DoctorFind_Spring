 $(function(){
        ...
        var areaSelectMaker = function(a1, a2, a3){
            ...
            areaKeys1.forEach(function(Region){
                $(a1).append("<option value="+Region+" ${addr1 eq "+Region+" ? 'selected' : '' }>"+Region+"</option>");
            });
            ...
            $(document).on("change", a1, function(){
                ...
                keys.forEach(function(Do){
                    $(a2).append("<option value="+Do+" ${addr2 eq "+Do+" ? 'selected' : '' }>"+Do+"</option>");    
                });
                ...
                keys.forEach(function(SiGunGu){
                    $(a3).append("<option value="+area[Region][Do][SiGunGu]+" ${addr3 eq "+area[Region][Do][SiGunGu]+" ? 'selected' : '' }>"+area[Region][Do][SiGunGu]+"</option>");    
                });
            });
